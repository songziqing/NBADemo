...
<body>
	<div class="container">
		<div class="row">
			<ul class="nav nav-tabs col-md-12">
				...
				<li role="presentation" class="active"><a href="#">失误榜</a></li>
		...
		<div class="row">
			<ol class="breadcrumb">
				...
				<li><a href="__URL__/index#5F">失误榜</a></li>
 ...
 if($_GET[p]==null){ echo $key+1; } else { echo $_GET[p]*14+$key-13; } ?>
						...
						<td class="success"><?php echo ($vo["avgfault"]); ?><td><?php echo ($vo["sumfault"]); ?></td><td><?php echo ($vo["mpg"]); ?></td>
						<td><?php echo ($vo["gs"]); ?></td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			</table>
			<?php echo ($page); ?><a href="__URL__/index#5F" class="btn btn-primary pull-right">返回</a>
		</div>
	</div>
</body>
</html>