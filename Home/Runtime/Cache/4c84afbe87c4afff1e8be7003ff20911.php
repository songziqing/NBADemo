...
<body>
	<div class="container">
		<div class="row">
			<ul class="nav nav-tabs col-md-12">
				<li role="presentation" class="active"><a href="#">得分榜</a></li>
				...
				<li role="presentation"><a href="__URL__/moreShot">神投榜</a></li>
			</ul>
		</div>
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="__URL__/index">NBA统计</a></li>
				<li><a href="__URL__/index">得分榜</a></li>
 ...
 if($_GET[p]==null){ echo $key+1; } else { echo $_GET[p]*14+$key-13; } ?>
						...
						<td><?php echo ($vo["avgscore"]); ?><td><?php echo ($vo["score"]); ?></td><td><?php echo ($vo["shortrate"]); ?>%</td><td><?php echo ($vo["mpg"]); ?></td>
						<td><?php echo ($vo["gs"]); ?></td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			</table>
			<?php echo ($page); ?><a href="__URL__/index#0F" class="btn btn-primary pull-right">返回</a>
		</div>
	</div>
</body>
</html>